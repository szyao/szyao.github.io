...
$(document).ready(function() {
    ...
    var quick_list_preinstall = {
        '1':{
            title   :"About",
            url     :"about/",
            img     :"./static/icon/person.png",
            explain :"关于",
        },
        '2':{
            title   :"GitHub",
            url     :"https://github.com/szyao",
            img     :"./static/icon/github.png",
            explain :"GitHub",
        },
        '3':{
            title   :"云盘",
            url     :"https://www.alipan.com/drive/home",
            img     :"./static/icon/yun.png",
            explain :"阿里云盘",
        },
        '4':{
            title   :"知识库",
            url     :"https://www.yuque.com/szyao/note",
            img     :"./static/icon/yuque.png",
            explain :"语雀知识库",
        },
    };
